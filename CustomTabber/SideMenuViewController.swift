...
//        
        self.tableView.registerCellClass(BaseTableCellView.self)
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell: BaseTableCellView = BaseTableCellView(style: UITableViewCellStyle.Subtitle, reuseIdentifier: BaseTableCellView.identifier)
